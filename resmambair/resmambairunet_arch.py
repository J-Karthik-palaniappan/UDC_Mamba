...
class VSSBlock(nn.Module):
    def __init__(
        ...
        self.conv_3x3 = nn.Conv2d(hidden_dim, hidden_dim, kernel_size=3, padding=1)
        self.conv_5x5 = nn.Conv2d(hidden_dim, hidden_dim, kernel_size=5, padding=2)
        self.conv_7x7 = nn.Conv2d(hidden_dim, hidden_dim, kernel_size=7, padding=3)

        self.weight_3x3 = nn.Parameter(torch.tensor(0.3))
        self.weight_5x5 = nn.Parameter(torch.tensor(0.3))
        self.weight_7x7 = nn.Parameter(torch.tensor(0.4))
    ...
    def forward(self, input, x_size):
        ...
        #===================================================EDITED===========================================================
        x_3x3 = self.conv_3x3(x.permute(0, 3, 1, 2).contiguous())
        x_5x5 = self.conv_5x5(x.permute(0, 3, 1, 2).contiguous())
        x_7x7 = self.conv_7x7(x.permute(0, 3, 1, 2).contiguous())

        x = self.weight_3x3 * x_3x3 + self.weight_5x5 * x_5x5 + self.weight_7x7 * x_7x7
        x = x.permute(0 , 2 , 3 , 1)
        #===================================================EDITED===========================================================
